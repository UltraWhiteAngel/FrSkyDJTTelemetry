...
#define FLIP_OLED
//#define SSD1306 // 0.96 Inch OLED I2C IIC Communication Display 128*64 LCD Module
#define SSD1106 // Geekcreit® 1.3 Inch 4Pin White OLED LCD Display
...
class SSD1X06 {
  public:
    ...
    static void displayInt32(uint8_t line, uint8_t x, int32_t V);
    static void displayReal32(uint8_t line, uint8_t x, int32_t V, int8_t dp, uint8_t Separator);
